 ...
 */
#ifndef INCLUDED_BAR_PACKET_DROPPER_H
#define INCLUDED_BAR_PACKET_DROPPER_H
...
namespace bar {
	...
	class BAR_API packet_dropper : virtual public gr::block
	{
	public:
...
#endif /* INCLUDED_BAR_PACKET_DROPPER_H */
