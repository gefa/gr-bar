 ...
 */
#ifndef INCLUDED_BAR_PERIODIC_MSG_SOURCE_H
#define INCLUDED_BAR_PERIODIC_MSG_SOURCE_H
...
class BAR_API periodic_msg_source : virtual public gr::block
{
public:
...
#endif /* INCLUDED_BAR_PERIODIC_MSG_SOURCE */
