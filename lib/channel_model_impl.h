 ...
 */
#ifndef INCLUDED_BAR_CHANNEL_MODEL_IMPL_H
#define INCLUDED_BAR_CHANNEL_MODEL_IMPL_H
...
class BAR_API channel_model_impl : public bar::channel_model
{
private:
...
#endif /* INCLUDED_BAR_CHANNEL_MODEL_IMPL_H */
