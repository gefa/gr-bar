 ...
 */
#ifndef INCLUDED_BAR_RANDOM_PERIODIC_MSG_SOURCE_IMPL_H
#define INCLUDED_BAR_RANDOM_PERIODIC_MSG_SOURCE_IMPL_H
...
#endif /* INCLUDED_BAR_RANDOM_PERIODIC_MSG_SOURCE_IMPL_H */
